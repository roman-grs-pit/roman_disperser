...
1. **STPSF Integration (Complete)**
   ...
   - Documentation: `docs/stpsf.md` (quick reference) + `docs/reference/stpsf_full.md` (comprehensive)
...
- @docs/stpsf.md - STPSF quick reference (see @docs/reference/stpsf_full.md Section 18 for coordinates)
